...
<div class="w-full px-4 lg:w-4/12">
                            <div class="relative w-full mb-3">
                              ...
                              <div class="mb-3 pt-0"><input required id="email" name="email" maxlength="30" class="border-blueGray-300 px-3 py-2 text-sm  w-full placeholder-blueGray-200 text-blueGray-700 relative bg-white rounded-md outline-none focus:ring focus:ring-lightBlue-500 focus:ring-1 focus:border-lightBlue-500 border border-solid transition duration-200"></div>
                            </div>
                          </div>
                          {{-- Middle Name --}}
                          <div class="w-full px-4 lg:w-4/12">
                            <div class="relative w-full mb-3">
                              ...
                              <div class="mb-3 pt-0"><input required id="age" name="age" maxlength="20" class="border-blueGray-300 px-3 py-2 text-sm  w-full placeholder-blueGray-200 text-blueGray-700 relative bg-white rounded-md outline-none focus:ring focus:ring-lightBlue-500 focus:ring-1 focus:border-lightBlue-500 border border-solid transition duration-200"></div>
                            </div>
                          </div>
